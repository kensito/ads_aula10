			...
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnVisualizar" name="acao"
						value="btn-visualizar-de-exibir-filmes-jsp" class="btn btn-info"
						disabled>Visualizar</button>
					<button type="submit" class="btn btn-success" id="btnComprar"
						name="acao" value="btn-comprar-de-exibir-filmes-jsp" disabled>Comprar</button>
