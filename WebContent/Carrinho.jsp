	...
	<div class="container">
		...
		<form action="comprar_filmes.do" method="POST">
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnFinalizar" name="acao"
						value="btn-finalizar-de-carrinho-jsp" class="btn btn-primary">Finalizar
						Compra</button>
					<button type="submit" id="btnVisualizar" name="acao"
						value="btn-visualizar-de-carrinho-jsp" class="btn btn-info"
						disabled>Visualizar</button>
					<input type="button" class="btn btn-danger" id="btnExcluir"
						data-toggle="modal" data-target="#delete-modal" value="Excluir"
						disabled> <a href="index.jsp" class="btn btn-default">Voltar</a>
				</div>
			</div>
			<!-- modal -->
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="submit" name="acao"
								value="btn-excluir-de-modal-carrinho-jsp" class="btn btn-danger">Excluir</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
						...
						<c:forEach var="filme" items="${filmes}">
							<tr>
								<td><div class="checkbox">
										<label> <input type="checkbox" name="box${filme.id}"
											onClick="tratarBotoes(this)">
										</label>
									</div></td>
