			...
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnEditar" name="acao"
						value="btn-editar-de-listar-filmes-jsp" class="btn btn-primary"
						disabled>Editar</button>
					<button type="submit" id="btnVisualizar" name="acao"
						value="btn-visualizar-de-listar-filmes-jsp" class="btn btn-info"
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="submit" name="acao"
								value="btn-excluir-de-modal-listar-filmes-jsp"
